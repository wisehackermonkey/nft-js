...
<h2 align="center">Nft flowfield art generator using p5.js</h2>

<h4 align="center">used to generate multiple permutations of a flowfield simulator</h4>
...
[![](https://contrib.rocks/image?repo=wisehackermonkey/nft-js)](https://github.com/wisehackermonkey/nft-js/graphs/contributors)
...
# License
#### MIT © wisehackermonkey
[![MIT](https://img.shields.io/github/license/wisehackermonkey/nft-js.svg)](https://github.com/wisehackermonkey/nft-js/blob/master/LICENSE)
-->
...
[![GitHub release](https://img.shields.io/github/release/wisehackermonkey/nft-js.svg)](https://GitHub.com/wisehackermonkey/nft-js/releases/)
[![GitHub tag](https://img.shields.io/github/tag/wisehackermonkey/nft-js.svg)](https://GitHub.com/wisehackermonkey/nft-js/tags/)
[![GitHub pull-requests](https://img.shields.io/github/issues-pr/wisehackermonkey/nft-js.svg)](https://GitHub.com/wisehackermonkey/nft-js/pull/)
...
```bash
cd ~
git clone https://github.com/wisehackermonkey/nft-js.git
cd nft-js
...
git clone https://github.com/wisehackermonkey/nft-js.git
cd nft-js
docker build -t wisehackermonkey/nft-js:latest .  
```
### Run
```bash
docker run -it --rm --name wisehackermonkey/nft-js:latest  
```
### Docker-compose
```bash
...
docker build -t wisehackermonkey/nft-js:latest .
docker login
docker push wisehackermonkey/nft-js:latest
```
